...
import com.ofoegbuvgmail.accidentreport.model.User;
import com.ofoegbuvgmail.accidentreport.utills.DialogUtils;

import es.dmoral.toasty.Toasty;

public class SignInActivity extends AppCompatActivity implements View.OnClickListener, UserDB.GetUser, UserDB.GetUserAfterSignIn {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneSignIn = findViewById(R.id.sign_in_with_phone_button);
        ...
        googleSignInErrordialog = new MaterialDialog.Builder(this)
                ...
                .onNegative((dialog, which) -> spinKitView.setVisibility(View.GONE));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.sign_in_with_google_button:
                ...
                SignInActivity.this.startActivityForResult(signInIntent, RC_SIGN_IN);
                break;
            case R.id.sign_in_with_phone_button:
                break;
        }
    }
